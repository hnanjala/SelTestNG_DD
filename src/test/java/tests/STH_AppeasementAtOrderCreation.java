...
public class STH_AppeasementAtOrderCreation {
...
//				rb.keyRelease(KeyEvent.VK_ENTER);
		...
		List<WebElement> customerFirstName = driver.findElements(objMap.getLocator("customerFirstName"));
				...
				Thread.sleep(4000);
				driver.findElement(objMap.getLocator("addAppeasementOrderLine")).click();
				Thread.sleep(2000);
			   ...
			   // func.dropDownByValue(driver.findElement(objMap.getLocator("appeasementReason")), "MANUAL PROMO");
			    driver.findElement(objMap.getLocator("appeasementCode_ManualPromo")).click();
			    Thread.sleep(2000);
				...
				/****PLEASE WORK ON THE PENDING STEPS****/
